...
public abstract class JAXBGenerateTest extends AbstractMojoTestCase {
	...
	protected void setUp() throws Exception {
		...
		mavenProjectBuilder = (MavenProjectBuilder) new DefaultProjectBuilder();
	}

	protected static File getBaseDir() {
		try {
			return (new File(JAXBGenerateTest.class.getProtectionDomain().getCodeSource().getLocation().getFile()))
	...
	public void testExecute() throws Exception {
		...
		final File pom = new File(getBaseDir(), "src/test/resources/test-pom.xml");
